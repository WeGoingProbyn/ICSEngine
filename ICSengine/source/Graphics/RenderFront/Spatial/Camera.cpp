#include "Graphics/RenderFront/Spatial/Camera.h"

Camera::Camera()
{
	m_Position = Vector<float, 3>(0.000f, 0.000f, 50.0f);
...
//}
// 
//Matrix<float, 4> Camera::TranslateCamera() {
//	Matrix<float, 4> CameraVectors(true, 1);
//	Matrix<float, 4> CameraPosition(true, 1);
//
